...
public class CraftingFilterView : MonoBehaviour, IFilterView
{
    ...
    public void InitializeCategories(CraftingCategory[] categories)
    {
        ...
        {
            Debug.LogWarning("[CraftingFilterView] No categories provided");
            return;
        }
    ...
    private void CreateCategoryButton(CraftingCategory category)
    {
        ...
        {
            Debug.LogError("[CraftingFilterView] Missing prefab or container reference");
            return;
        }
        ...
        {
            Debug.LogWarning($"[CraftingFilterView] Category button already exists: {category}");
            return;
        }
        ...
        {
            Debug.LogError("[CraftingFilterView] CategoryButtonUI component not found on prefab");
            Destroy(buttonObj);
        }
    }

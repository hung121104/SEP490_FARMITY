...
], Character.prototype, "worldId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'Account', required: true }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Character.prototype, "accountId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Character.prototype, "positionX", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Character.prototype, "positionY", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Character.prototype, "chunkIndex", void 0);
exports.Character = Character = __decorate([
    (0, mongoose_1.Schema)()
], Character);
exports.CharacterSchema = mongoose_1.SchemaFactory.createForClass(Character);
exports.CharacterSchema.index({ worldId: 1, accountId: 1 }, { unique: true });

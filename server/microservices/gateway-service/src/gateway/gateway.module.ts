  ...
  configure(consumer: MiddlewareConsumer) {
    ...
    consumer
      ...
      .forRoutes(
        ...
        { path: 'player-data/combat/progression', method: RequestMethod.GET },
        { path: 'player-data/combat/progression', method: RequestMethod.PUT },
        { path: 'player-data/combat/health', method: RequestMethod.GET },
        { path: 'player-data/combat/health', method: RequestMethod.PUT },
